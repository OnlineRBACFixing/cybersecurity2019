...
role0 role1 role2 role3 role4 role5 role6 role7 role8 - role)
(:init 
...
(not(rolePermission role6 permission8))
(not(rolePermission role6 permission9))
(rolePermission role6 permission10)
(not(rolePermission role7 permission0))
(not(rolePermission role7 permission1))
(not(rolePermission role7 permission2))
